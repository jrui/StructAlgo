...
export class HeapSort<T> {
    ...
    constructor(array: T[] = [], comparatorFn = HeapSort.defaultComparator) {
        this.values = [...array];
     ...
     */
    private static heapify(array: any[], heapSize: number, rootIndex: number, comparatorFn: (a: any, b: any) => number): void {
